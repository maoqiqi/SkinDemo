...
import com.software.march.skin.manager.SkinLayoutInflaterManager;
...
public class SkinAppCompatViewInflater {
    ...
    private static final String LOG_TAG = "SkinViewInflater";
    ...
    public final View createView(View parent, final String name, @NonNull Context context,
        ...
        if (view == null) {
            /**
             * 根据{@link SkinLayoutInflaterManager}创建视图
             */
            view = createViewFromInflater(context, name, attrs);
        }

        if (view == null) {// view == null && originalContext != context
    ...
    private View createViewFromInflater(Context context, String name, AttributeSet attrs) {
        View view = null;
        for (SkinLayoutInflater inflater : SkinLayoutInflaterManager.getInstance().getSkinLayoutInflaters()) {
            view = inflater.onCreateView(context, name, attrs);
            if (view == null) {
                continue;
            } else {
                break;
